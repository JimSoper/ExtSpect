...
Ext.Loader.require( 'Ext.util.HashMap',
                    function () {
	                    Ext.util.HashMap.prototype.extspectString =
		                    function () {
			                    return uxExtSpect.util.StringOf.embrace$( "HashMap", uxExtSpect.util.StringOf.to$( this.getValues() ) );
		                    };
...
Ext.Loader.require( 'Ext.data.Store',
                    function () {
	                    Ext.data.Store.prototype.extspectString =
		                    function () {
			                    var string = uxExtSpect.util.StringOf.quote$( this.getStoreId() || this.getId() );
			                    return uxExtSpect.util.StringOf.embrace$( "Store", string );
		                    };
...
Ext.Loader.require( 'Ext.data.proxy.Proxy',
                    function () {
	                    Ext.data.proxy.Proxy.prototype.extspectString =
		                    function () {
			                    var string = uxExtSpect.util.StringOf.quote$( this.id );
			                    return uxExtSpect.util.StringOf.embrace$( "Proxy", string );
		                    };
...
Ext.Loader.require( 'Ext.data.Field',
                    function () {
	                    Ext.data.Field.prototype.extspectString =
		                    function () {
			                    return uxExtSpect.util.StringOf.embrace$( "Field", uxExtSpect.util.StringOf.quote$( this.getName() ) );
		                    };
...
Ext.dom.Element.prototype.extspectString =
	function () {
		return uxExtSpect.util.StringOf.embrace$( "ExtElmnt", uxExtSpect.util.StringOf.quote$( this.id ) );
	};
...
Function.prototype.extspectString = function () {
	if ( this.hasOwnProperty( "modelName" ) ) {
		var string = uxExtSpect.util.StringOf.quote$( uxExtSpect.util.StringOf.functionName( this ) );
		return uxExtSpect.util.StringOf.embrace$( 'MdlCls', string );
	}
...
RegExp.prototype.extspectString = function () {
	return uxExtSpect.util.StringOf.ellipsis$( uxExtSpect.util.StringOf.embrace$( 'RegExp', this ) );
};
RegExp.prototype.extspectString._name = 'RegExp#extspectString';

// typeof( new String( 'ABC' ) ) -> 'object'
String.prototype.extspectString = function () {
	return uxExtSpect.util.StringOf.embrace$( 'String', uxExtSpect.util.StringOf.quote$( this ) );
};
...
DOMTokenList.prototype.extspectString =
	function () {
		return uxExtSpect.util.StringOf.embrace$( "DomTknList", uxExtSpect.util.StringOf.object$( this ) );
	};
DOMTokenList.prototype.extspectString._name = 'DOMTokenList#extspectString';

HTMLCollection.prototype.extspectString =
	function () {
		return uxExtSpect.util.StringOf.bracket$( "HtmlClctn", uxExtSpect.util.StringOf.object$( this ) );
	};
...
KeyboardEvent.prototype.extspectString = function () {
	var dataString = '';
	if ( "keyCode" in this ) {
		dataString = uxExtSpect.util.StringOf.keyCode$( this.keyCode ) + ', ' + this.charCode;
	}
...
if ( this.NamedNodeMap ) { // not in FireFox
