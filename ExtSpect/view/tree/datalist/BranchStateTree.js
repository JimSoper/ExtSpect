...
A BranchStateTree allows double taps and long presses
 ...
 between redraws of the Tree. There is 1 state object per
 list, identified by the listIdString.
 */

Ext.define(
	'uxExtSpect.view.tree.datalist.BranchStateTree',
	{  extend : 'uxExtSpect.view.tree.datalist.TreeList',
		...
		fetchInitialBranchState : function ( object ) { return 'all'; },

		branchStateObjectFor : function ( object, listIdString )
		{
			var stateObject = object.hasOwnProperty( 'esBranchStateObject' ) &&
				object.esBranchStateObject;

			if ( ! stateObject )
			{
				stateObject = new Object();
				stateObject[ listIdString ] = this.fetchInitialBranchState( object );
			}
			object.esBranchStateObject = stateObject;
