Ext.define(
	'uxExtSpect.view.object.datalist.property.PropertiesList',
	{  extend: 'uxExtSpect.view.object.datalist.PropertiesOrArrayList',
		...
		determinePropertyGroup: function ( property ) {
			...
			if ( ( property.search( 'Animation' ) !== - 1 ) ) { return '= ANIMATION ='; }

			if ( ( property === "config" ) || ( property.search( 'Config' ) !== - 1 ) ||
				( property.search( 'defaults' ) !== - 1 )
				) { return '= CONFIG ='; }

			if ( ( property.search( 'class' ) !== - 1 ) || ( property.search( 'Class' ) !== - 1 ) ) { return '= CLASS ='; }

			if ( ( property.search( 'cls' ) !== - 1 ) || ( property.search( 'Cls' ) !== - 1 ) ) { return '= CSS CLASS ='; }
			...
			if ( ( property.search( 'element' ) !== - 1 ) || ( property.search( 'Element' ) !== - 1 ) ||
				...
				( property.search( 'dom' ) !== - 1 ) ) { return '= ELEMENT ='; }
			...
			if ( ( property === "parent" ) ||
				( property === "_rootObject" ) ) { return "= ITEM ="; }

			if ( ( property.search( 'item' ) !== - 1 ) || ( property.search( 'Item' ) !== - 1 ) ) { return '= ITEM ='; }

			if ( ( property === "mixins" ) || ( property.search( 'Mixin' ) !== - 1 ) ) { return '= MIXIN ='; }
			...
			if ( property.search( 'reference' ) !== - 1 ) { return '= REFERENCE ='; }

			if ( ( property.search( 'tpl' ) !== - 1 ) || ( property.search( 'Tpl' ) !== - 1 ) ) { return '= TEMPLATE ='; }

			if ( ( property.search( "text" ) !== - 1 ) || ( property.search( "Text" ) !== - 1 ) ) { return "= TEXT ="; }
		...
		determineGroup: function ( value, property ) {    // search in property names
			...
			if ( this.isCollectionValue( value ) ) { return this.determineCollectionGroup( value, property ); }

			if ( value instanceof Object ) { return this.determineObjectGroup( value, property ); }

			return this.determineItemGroup( value, property );
		},

		isGroupedOk: function () { return this.fetchParentNavigationView().isDataListGrouped; },
