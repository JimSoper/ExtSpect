Ext.define(
	...
	{  extend : 'uxExtSpect.view.tree.datalist.BranchStateTree' ,
		...
		{  // console.log( component.defaultIdPrefix )
			return ( this.isShowableContainer( component ) ||
				this.fetchParentNavigationView().showComponents );
		} ,

		// returns those items that are containers but not ListItem
		objectSubparts : function ( component )
		{
			if ( ! this.isShowableContainer( component ) )
			{ return []; }
		...
		fetchInitialBranchState : function ( object )
		{
			return ( object === uxExtSpect.instance ) ? 'none' : 'all';
		} ,
